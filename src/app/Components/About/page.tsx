      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-800 text-lg leading-relaxed">
            I’m Ikhlas Bano, an undergraduate Computer Engineering student with a keen interest in software development and system engineering. Eager to grow in a dynamic environment, I’m focused on building skills that enhance my technical expertise and analytical thinking.
          </p>
          <p className="text-gray-800 text-lg leading-relaxed">
